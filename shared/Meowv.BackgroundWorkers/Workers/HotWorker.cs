...
public class HotWorker : QuartzBackgroundWorkerBase
{
        ...
        ILocalEventBus localEventBus)
    {
        ...
        {
            if (!await scheduler.CheckExists(JobDetail.Key)) await scheduler.ScheduleJob(JobDetail, Trigger);
        };
    }
    ...
    public override async Task Execute(IJobExecutionContext context)
    {
        ...
        foreach (var item in Hot.KnownSources.Dictionary)
        {
            var task = await Task.Factory.StartNew(async () =>
            {
                ...
                try
                {
                    switch (source)
                    {
                        case Hot.KnownSources.juejin or Hot.KnownSources.csdn or Hot.KnownSources.zhihu
                            or Hot.KnownSources.huxiu or Hot.KnownSources.douyin or Hot.KnownSources.woshipm
                            ...
                            switch (source)
                            {
                                ...
                                default:
                                {
                                    var content = new ByteArrayContent(
                                        "{\"id_type\":2,\"client_type\":2608,\"sort_type\":3,\"cursor\":\"0\",\"limit\":20}"
                                            .GetBytes());
                        ...
                        {
                            var encoding =
                                source is Hot.KnownSources.baidu or Hot.KnownSources.news163 or Hot.KnownSources.pojie52
        ...
        Parallel.ForEach(tasks, new ParallelOptions { MaxDegreeOfParallelism = 10 }, async task =>
        {
            ...
            {
                await _hots.DeleteAsync(x => x.Source == source, true);
            ...
            switch (source)
            {
                ...
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode.SelectNodes("//ul[@class='news-list']/li/div[@class='txt-box']/h3/a")
                        .ToList();
                ...
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode.SelectNodes("//div[@class='channel-item']/div[@class='bd']/h3/a")
                        .ToList();
                ...
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode.SelectNodes("//div[@class='ui items']/div/div[@class='content']/a")
                        .ToList();
                ...
                case Hot.KnownSources.kr36:
                {
                    ...
                    var nodes = html.DocumentNode
                        .SelectNodes(
                            "//div[@class='list-wrapper']/div[@class='list-section-wrapper']/div[@class='article-list']/div/div/div/div/div/p/a")
                        .ToList();
                ...
                case Hot.KnownSources.baidu:
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode
                        .SelectNodes("//table[@class='list-table']//tr/td[@class='keyword']/a[@class='list-title']")
                        .ToList();
                ...
                case Hot.KnownSources.toutiao:
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode
                        .SelectNodes("//div[@class='posts']/div[@class='post']/div[@class='content']/h3/a").ToList();
                ...
                case Hot.KnownSources.imooc:
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode
                        .SelectNodes("//div[@class='articleCon js-usercard-box']/div/div/a[@class='title']").ToList();
                ...
                case Hot.KnownSources.news163:
                {
                    ...
                    var nodes = html.DocumentNode
                        .SelectNodes(
                            "//div[@class='area-half left']/div[@class='tabBox']/div[@class='tabContents active']/table//tr/td[1]/a")
                        .ToList();
                ...
                case Hot.KnownSources.sspai:
                {
                    ...
                    var nodes = html.DocumentNode
                        .SelectNodes(
                            "//div[@class='article']/div[@class='articleCard']/div/div/div/div[@class='card_content']/a")
                        .ToList();
                ...
                {
                    var html = result as HtmlDocument;
                    var content = HttpUtility.UrlDecode(html.DocumentNode.SelectSingleNode("//div[@id='list-hotposts']")
                        .InnerHtml);
                ...
                case Hot.KnownSources.tianya:
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode
                        .SelectNodes("//div[@id='main']/div[@class='mt5']/table/tbody/tr/td[1]/a").ToList();
                ...
                {
                    var html = result as HtmlDocument;
                    var nodes = html.DocumentNode.SelectNodes("//ul[@class='rank-list']/li/div/div[@class='info']/a")
                        .ToList();
