...
public class MeowvBlogApplicationAutoMapperProfile : Profile
{
    ...
    {
        CreateMap<Post, PostDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));

        CreateMap<Post, PostDetailDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().FormatTime()));
        ...
        CreateMap<Post, GetAdminPostDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));
        ...
        CreateMap<Hot, HotDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));

        CreateMap<Saying, SayingDto>();

        CreateMap<Signature, SignatureDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));

        CreateMap<Message, MessageDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));

        CreateMap<MessageReply, MessageReplyDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));

        CreateMap<User, UserDto>().ForMember(x => x.CreatedAt,
            dto => dto.MapFrom(opt => opt.CreatedAt.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss")));
    }
}