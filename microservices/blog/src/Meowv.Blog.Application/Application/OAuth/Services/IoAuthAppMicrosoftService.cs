...
public class IoAuthAppMicrosoftService : IoAuthAppServiceBase<MicrosoftOptions, AccessTokenBase, MicrosoftUserInfo>
{
    ...
    public override async Task<UserDto> GetUserByOAuthAsync(string type, string code, string state)
    {
        ...
        return await UserAppService.CreateUserAsync(userInfo.Email, type, userInfo.Id, userInfo.Name, userInfo.Avatar,
            userInfo.Email);
    }
