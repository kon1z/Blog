...
public class IoAuthAppWeiboService : IoAuthAppServiceBase<WeiboOptions, WeiboAccessToken, WeiboUserInfo>
{
    ...
    public override async Task<WeiboUserInfo> GetUserInfoAsync(WeiboAccessToken accessToken)
    {
        ...
        var response =
            await client.GetStringAsync(
                $"{Options.Value.UserInfoUrl}?access_token={accessToken.AccessToken}&uid={accessToken.Uid}");
